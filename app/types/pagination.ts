...
export interface ExtendedPaginator<T extends LucidRow = LucidRow>
  extends ModelPaginatorContract<T> {
  hasNextPage: boolean
  hasPreviousPage: boolean
}

// Fonction helper pour calculer les propriétés de pagination
export function extendPaginator<T extends LucidRow = LucidRow>(
